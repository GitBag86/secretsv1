...
- [ ] Session persistence (keep unlocked for N minutes)
- [ ] Auto-lock on idle
...
1. **Replace stub sync code** — Supabase client is mostly stubs, needs real implementation
2. **Add error boundaries** — Frontend has no error handling for failed Tauri calls
